...
function App() {
  ...
  const seoData = routeSeoData[location as keyof typeof routeSeoData] || {
    title: "Секрет Натальи - Профессиональный салон красоты",
    description: "Профессиональный салон красоты Секрет Натальи предлагает услуги косметологии, массажа и спа-процедур.",
    schemaType: "WebPage"
  };
